export const Welcome_template = ({ name }) => {
  const welcome_message = `
        ...
        <head>
            ...
            <title>AbaNAba | Email template</title>
                ...
                <td>
                    ...
                    <thead>
                        ...
                        <td style="display: block">
                            ...
                            "
                            >
                            Hi ${name?.toUpperCase()} And Welcome To AbaNAba.!
                            </h3>
                        </td>
                        ...
                        <td>
                            ...
                            "
                            >
                            We hope our product will lead you, like many other before
                            you. to a place where yourideas where your ideas can spark
                            and grow.n a place where you’ll find all your inspiration
                            needs. before we get started, we’ll need to verify your
                            email.
                            </p>
                        </td>
                        </tr>
                    ...
                    <thead>
                        ...
                        <td style="display: block">
                            ...
                            vixit our <span class="theme-color">FAQs.</span> You can
                            also chat with a real live human during our operating
                            hours. they can answer questions about account or help you
